package Course2.Lessons.Lesson_2.Games.Bricks;


import Course2.Lessons.Lesson_2.Games.Common.CommonObject;
import Course2.Lessons.Lesson_2.Games.Common.Controller;
...
public class MainBricks extends JFrame implements Controller {
    ...
    private static final int Window_HHEIGHT = 600;
    ...
    private MainBricks() {
        ...
        setBounds(POS_X, POS_Y, WINDOW_WIDTH, Window_HHEIGHT);
        setTitle("Bricks");
